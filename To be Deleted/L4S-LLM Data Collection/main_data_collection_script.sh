...
client_iperf3_script() {
    ...
    ssh -i ~/.ssh/mptcprootkey root@$client1_ipaddr "iperf3 -c 172.16.1.2 -t $duration -p 5101 -J > iperf3_client_${tcp1}_${testname}.json" >/dev/null &       
    ssh -i ~/.ssh/mptcprootkey root@$client2_ipaddr "iperf3 -c 172.16.1.2 -t $duration -p 5102 -J > iperf3_client_${tcp1}_${testname}.json"
    sleep $end_wait_time
    # wait
}
