...
# %%
print(filtered_udp)
print(os.path.getsize(filtered_udp[0]))


# %%
print(filtered_tcp)
print(os.path.getsize(filtered_tcp[0]))
print(os.path.getsize(filtered_tcp[1]))

# %%
for scenario in scenario_dict.keys():
    index = "1_dualpi2"

    search_list_tcp = [index, "log", "src","newreno"]
    filtered_tcp = filter_strings_by_substrings(scenario_dict[scenario], search_list_tcp)
    ...
    tcp_traffic = filtered_tcp[0]
    ttf = get_dataframe_from_filepath(tcp_traffic)
    ttf1 = ttf[ttf['ForeignPort'] == "5102"]
    ttf2 = ttf[ttf['ForeignPort'] == "5103"]
