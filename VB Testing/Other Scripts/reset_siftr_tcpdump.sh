...
ssh -p "$src1port" -i "$sshkeypath" root@"$vmhostaddr" "rm *.siftr.log;rm *.pcap;rm *.out;rm *.json;rm *dualpi2*.txt"
ssh -p "$src2port" -i "$sshkeypath" root@"$vmhostaddr" "rm *.siftr.log;rm *.pcap;rm *.out;rm *.json;rm *dualpi2*.txt"
ssh -p "$dsthostport" -i "$sshkeypath" root@"$vmhostaddr" "rm *.siftr.log;rm *.pcap;rm *.out;rm *.json;rm *dualpi2*.txt"
ssh -p "$router1port" -i "$sshkeypath" root@"$vmhostaddr" "rm *.siftr.log;rm *.pcap;rm *.out;rm *.json;rm *dualpi2*.txt"
...
ssh -p "$src1port" -i "$sshkeypath" root@"$vmhostaddr" "killall iperf3;pkill -f udp_prague_sender"
ssh -p "$src2port" -i "$sshkeypath" root@"$vmhostaddr" "killall iperf3;pkill -f udp_prague_sender"
ssh -p "$dsthostport" -i "$sshkeypath" root@"$vmhostaddr" "killall iperf3"

ssh -p "$dsthostport" -i "$sshkeypath" root@"$vmhostaddr" "pkill screen; pkill -f udp_prague_receiver"
